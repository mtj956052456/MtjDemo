package com.example.pmprogect.fragment.home.multithreading.download.execute;
...
public class DownloadTask implements Runnable {
    ...
    private void download() {
        ...
        try {
            ...
            sizeHttp.setRequestProperty("Accept-Encoding", "identity");
            sizeHttp.connect();
            ...
            Log.e(TAG, "download: "+ http.getContentLength());
